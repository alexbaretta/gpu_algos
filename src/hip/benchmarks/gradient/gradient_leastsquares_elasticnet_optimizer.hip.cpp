...
// source path: src/hip/benchmarks/gradient/gradient_leastsquares_elasticnet_optimizer.hip.cpp
...
#include "hip/kernels/gradient/gradient_leastsquares_elasticnet_optimizer.hip.hpp"
