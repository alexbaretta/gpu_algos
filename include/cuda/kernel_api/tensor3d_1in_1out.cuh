...
// source path: include/cuda/kernel_api/tensor3d_1in_1out.cuh
...
concept TENSOR3D_KERNEL_SPEC_1IN_1OUT = requires (Kernel_spec spec) {
...
struct Check_tensor3d_kernel_spec_1In_1Out {
    ...
    static_assert(TENSOR3D_KERNEL_SPEC_1IN_1OUT<Kernel_spec>, "not a valid TENSOR3D_KERNEL_SPEC_1IN_1OUT");

    constexpr static bool check_passed = true;
};

template <typename Kernel>
concept TENSOR3D_KERNEL_1IN_1OUT = requires (Kernel kernel) {
...
struct Check_tensor3d_kernel_1In_1Out {
    ...
    static_assert(TENSOR3D_KERNEL_1IN_1OUT<Kernel>, "not a valid TENSOR3D_KERNEL_1IN_1OUT");
...
struct Check_tensor3d_kernel_1In_1Out_template {
    static_assert(Check_tensor3d_kernel_1In_1Out<Kernel<std::int8_t>>::check_passed);
    static_assert(Check_tensor3d_kernel_1In_1Out<Kernel<std::uint8_t>>::check_passed);
    static_assert(Check_tensor3d_kernel_1In_1Out<Kernel<__half>>::check_passed);
    static_assert(Check_tensor3d_kernel_1In_1Out<Kernel<float>>::check_passed);
    static_assert(Check_tensor3d_kernel_1In_1Out<Kernel<double>>::check_passed);
