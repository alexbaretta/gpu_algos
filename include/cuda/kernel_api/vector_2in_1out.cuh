...
concept VECTOR_KERNEL_SPEC_2IN_1OUT = requires (Kernel_spec spec) {
...
struct Check_vector_kernel_spec_2In_1Out {
    ...
    static_assert(VECTOR_KERNEL_SPEC_2IN_1OUT<Kernel_spec>, "not a valid VECTOR_KERNEL_SPEC_2IN_1OUT");

    constexpr static bool check_passed = true;
};

template <typename Kernel>
concept VECTOR_KERNEL_2IN_1OUT = requires (Kernel kernel) {
...
struct Check_vector_kernel_2In_1Out {
    ...
    static_assert(VECTOR_KERNEL_2IN_1OUT<Kernel>, "not a valid VECTOR_KERNEL_2IN_1OUT");
...
struct Check_vector_kernel_2In_1Out_template {
    static_assert(Check_vector_kernel_2In_1Out<Kernel<std::int8_t>>::check_passed);
    static_assert(Check_vector_kernel_2In_1Out<Kernel<std::uint8_t>>::check_passed);
    static_assert(Check_vector_kernel_2In_1Out<Kernel<__half>>::check_passed);
    static_assert(Check_vector_kernel_2In_1Out<Kernel<float>>::check_passed);
    static_assert(Check_vector_kernel_2In_1Out<Kernel<double>>::check_passed);
