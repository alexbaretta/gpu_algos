...
__global__ void gradient_leastsquares_elasticnet_optimizer(
    ...
    CUDA_Number* M,                     // n x k matrix (coefficients - input/output)
    CUDA_Number* temp_gradient,         // n x k temporary gradient storage
    CUDA_Number* temp_candidates,       // n_points * n * k temporary candidates
    CUDA_Number* temp_losses,           // n_points temporary loss values
    CUDA_Number* temp_norm,             // temporary norm storage
    ...
    const CUDA_Number eta,              // learning rate
    const CUDA_Number alpha,            // L1 regularization parameter
    const CUDA_Number lambda,           // L2 regularization parameter
    const CUDA_Number tol,              // absolute tolerance
    const CUDA_Number rtol              // relative tolerance
) {
