...
// source path: include/cuda/kernels/vector_cumsum/vector_cumsum_parallel.cuh
...
static_assert(Check_vector_kernel_spec_1In_1Out<Vector_cumsum_parallel_spec>::check_passed, "Vector_cumsum_parallel_spec is not a valid kernel spec");
...
static_assert(Check_vector_kernel_1In_1Out_template<Vector_cumsum_parallel_kernel>::check_passed, "Vector_cumsum_parallel is not a valid kernel template");
