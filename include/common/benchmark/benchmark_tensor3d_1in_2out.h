...
#include "common/kernel_api/tensor3d_1in_2out.h"
...
class Benchmark_Tensor3D_1In_2Out {
    ...
    int run() {
        ...
        cuda_check_error(cudaMemcpyAsync(vec_B.data(), gpu_data_B, size_B_bytes, cudaMemcpyDeviceToHost, stream), "cudaMemcpyAsync");
