...
// source path: include/hip/benchmark/benchmark_vector_3in_1out.hip.hpp
...
#include "hip/kernel_api/vector_3in_1out.hip.hpp"
...
class Benchmark_Vector_3In_1Out {
    ...
    int run() {
        ...
        std::cout
            << "Input vectors size   : " << spec.n_A_ << ", " << spec.n_B_ << ", " << spec.n_C_ << "\n"
