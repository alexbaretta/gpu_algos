...
// source path: include/hip/kernel_api/tensor3d_2in_1out.hip.hpp
...
struct Check_tensor3d_kernel_spec_2In_1Out {
    ...
    static_assert(std::same_as<decltype(std::declval<Tensor3d_kernel_spec_2In_1Out>().dynamic_shared_mem_words_), const size_t>);
...
template <template <CUDA_scalar CUDA_Number> class Tensor3d_kernel_2In_1Out>
