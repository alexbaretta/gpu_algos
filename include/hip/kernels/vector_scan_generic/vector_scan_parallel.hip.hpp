...
// source path: include/hip/kernels/matrix/vector_scan_parallel.hip.hpp
...
class Vector_scan_parallel_kernel {
    ...
    void block_strided_pass(
        ...
        vector_scan_by_blocks_parallel<Number, Operation><<<curr_n_blocks, spec_.block_dim_, 0, stream>>>(
            prev_result,
            curr_result,
            curr_n_elems,
            spec_.block_dim_.x,
