...
// source path: include/hip/kernels/matrix/vector_scan_parallel.hpp
...
template <HIP_scalar Number_, typename Operation_>
class Vector_scan_parallel_kernel {
    ...
    void block_strided_pass(
        ...
        vector_scan_by_blocks_parallel<Number, Operation><<<curr_n_blocks, spec_.block_dim_, shared_mem_size, stream>>>(
            prev_result,
            curr_result,
            curr_n_elems,
            spec_.block_dim_.x,
    ...
    void run_device_kernel(
        ...
        // global scan.
        vector_scan_by_blocks_parallel<Number, Operation><<<spec_.grid_dim_, spec_.block_dim_, 0, stream>>>(
            gpu_data_A,
            gpu_data_C,
            spec_.n_,
            1
